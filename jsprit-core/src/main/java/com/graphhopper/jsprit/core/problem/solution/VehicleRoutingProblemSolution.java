...
/**
 * Contains the solution of a vehicle routing problem and its corresponding
 * costs.
 *
...
public class VehicleRoutingProblemSolution {
	...
	/**
	 * Constructs a solution with a number of {@link VehicleRoute}s and their
	 * corresponding aggregate cost value.
	 *
	...
	/**
	 * Constructs a solution with a number of {@link VehicleRoute}s, bad jobs and
	 * their corresponding aggregate cost value.
	 *
	 * @param routes         routes being part of the solution
	...
	public int hashCode() {
		...
		result = prime * result + ((routes == null) ? 0 : routes.size());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VehicleRoutingProblemSolution other = (VehicleRoutingProblemSolution) obj;
		if (Double.doubleToLongBits(cost) != Double.doubleToLongBits(other.cost))
			return false;
		if (routes == null) {
			if (other.routes != null)
				return false;
		} else if (routes.size() != other.getRoutes().size())
			return false;
		return true;
	}
