...
public class InsertionStrategyBuilder {
	...
	public InsertionStrategyBuilder(VehicleRoutingProblem vrp, VehicleFleetManager vehicleFleetManager,
	...
	public InsertionStrategy build() {
		...
		if (strategy.equals(Strategy.BEST)) {
			...
			if (executor == null) {
				...
				if (isFastRegret) {
					RegretInsertionConcurrentFast regret = new RegretInsertionConcurrentFast(costCalculator, vrp,
							executor, fleetManager);
					regret.setSwitchAllowed(allowVehicleSwitch);
					insertion = regret;
				} else {
